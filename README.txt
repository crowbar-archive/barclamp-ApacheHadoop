...
The Crowbar Framework (https://github.com/dellcloudedge/crowbar) was developed by the Dell CloudEdge Solutions Team (http://dell.com/crowbar) as a OpenStack installer (http://OpenStack.org) but has evolved as a much broader function tool. 
...
About this Apache Hadoop
-------------------------------------
This barclamp is a "meta barclamp."  It does not contain code for specific projects; instead, it is an umbrella to collect related barclamps that support the Apache Hadoop projects.
